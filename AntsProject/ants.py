...
Name: Partner A: Matthew Dabit  Partner B: Ari Feuer
Login: CS61a-fg, Cs61a-fq
TA: Robert
Section: 103
"""
...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if not insect.is_ant():
            ...
            if insect.__class__ == BodyguardAnt and insect.ant is not None:
                self.ant = insect.ant
            else:
                self.ant = None
        insect.place = None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while places_away < self.min_range or len(current_place.bees) == 0:
            if current_place.entrance.name == 'Hive' or places_away >= self.max_range:
                return None
            places_away += 1
    ...
    def action(self, colony):
        ...
        if self.action_taken:
            ...
            if current_place.entrance:
                ...
                while current_place.entrance.name != 'Hive':
