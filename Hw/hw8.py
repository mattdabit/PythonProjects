...
def apply(operator_name, shape):
    ...
    t = type_tag(shape)
    key = (operator_name, t)
    return apply.operator[key](shape)

apply.operator = {('area', 's'): lambda square: square.side**2,('perimeter', 's'): lambda square: square.side*4, ('area', 'r'): lambda rectangle: rectangle.width*rectangle.height, ('perimeter', 'r'): lambda rectangle: rectangle.width*2 + rectangle.height*2}
